...
I work across **AWS, Kubernetes, Docker, Terraform, GitOps, CI/CD, and observability**, building toward **SRE, Platform Engineering, and DevOps** roles.

I hold the **AWS Certified Solutions Architect – Associate** and **Certified Kubernetes Administrator (CKA)** certifications, and I'm continuously exploring **cloud-native architecture, platform engineering, and AI infrastructure**.